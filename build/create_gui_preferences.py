...
ui_dir = repo_root / "rootfs" / "usr" / "share" / "mitraos" / "ui"
ui_dir.mkdir(parents=True, exist_ok=True)

tcl_code = """#!/usr/bin/env wish
#//////////////////////////////////////////////////////////////////
...
(ui_dir / "preferences.tcl").write_text(tcl_code, encoding="utf-8")
print(f"[+] GUI script written to: {ui_dir / 'preferences.tcl'}")
